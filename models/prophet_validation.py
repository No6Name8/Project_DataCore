...
def generate_prophet_report(uci_metrics, synth_metrics,
    ...
    lines.append("- 90-day synthetic window covers weekly but not yearly seasonality")
    lines.append("- MAPE inflated for sparse businesses (real estate, auto) by")
    lines.append("  zero-revenue days in test set; SMAPE or MAE preferred for")
    lines.append("  intermittent time series")
    lines.append("")
